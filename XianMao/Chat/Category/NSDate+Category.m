...
/*距离当前的时间间隔描述2*/
- (NSString *)nowtimeIntervalDescription
{
    NSTimeInterval timeInterval = -[self timeIntervalSinceNow];
...
//        NSDateFormatter *dateFormatter = [NSDateFormatter dateFormatterWithFormat:@"M个月d天"];
//        return [dateFormatter stringFromDate:self];
        return [NSString stringWithFormat:@"%.f天", timeInterval / 86400];
    } else {
...
- (NSString *)formattedDateDescriptionMF
{
    ...
    if (timeInterval < 60) {
        ...
        return [NSString stringWithFormat:@"付款还剩%ld分钟", timeInterval / 60];
    } else {//if (timeInterval < 21600) {//6小时内
        return [NSString stringWithFormat:@"付款还剩%ld小时", timeInterval / 3600];
    }// else if ([theDay isEqualToString:currentDay]) {//当天
//        [dateFormatter setDateFormat:@"HH:mm"];
//        return [NSString stringWithFormat:@"付款还剩 %@", [dateFormatter stringFromDate:self]];
//    } else if ([[dateFormatter dateFromString:currentDay] timeIntervalSinceDate:[dateFormatter dateFromString:theDay]] == 86400) {//昨天
//        [dateFormatter setDateFormat:@"HH:mm"];
//        return [NSString stringWithFormat:@"付款还剩 %@", [dateFormatter stringFromDate:self]];
//    } else {//以前
...
/*格式化日期描述*/
- (NSString *)XMformattedDateDescription
{
    NSDateFormatter *dateFormatter = [[NSDateFormatter alloc] init];
