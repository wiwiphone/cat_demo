...
#define BUBBLE_RIGHT_IMAGE_NAME @"chat_sender_bg_New_Gray"
#define BUBBLE_ARROW_WIDTH 5 // bubbleView中，箭头的宽度
#define BUBBLE_VIEW_PADDING 6 // bubbleView 与 在其中的控件内边距

#define BUBBLE_RIGHT_LEFT_CAP_WIDTH 10//10 // 文字在右侧时,bubble用于拉伸点的X坐标
#define BUBBLE_RIGHT_TOP_CAP_HEIGHT 20 // 文字在右侧时,bubble用于拉伸点的Y坐标             //格局需求修改聊天背景图片  拉伸位置  2016.4.19 Feng

#define BUBBLE_LEFT_LEFT_CAP_WIDTH 10 //24 // 文字在左侧时,bubble用于拉伸点的X坐标
#define BUBBLE_LEFT_TOP_CAP_HEIGHT 35//20 // 文字在左侧时,bubble用于拉伸点的Y坐标
