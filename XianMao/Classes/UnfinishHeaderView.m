...
@implementation UnfinishHeaderView
...
-(CommandButton *)unPassVerify{
    if (!_unPassVerify) {
        ...
        [_unPassVerify setTitle:@"已关闭" forState:UIControlStateNormal];
...
-(CommandButton *)passVerify{
    if (!_passVerify) {
        ...
        [_passVerify setTitle:@"已下架" forState:UIControlStateNormal];
...
-(CommandButton *)waitVerify{
    if (!_waitVerify) {
        ...
        [_waitVerify setTitle:@"寄回中" forState:UIControlStateNormal];
