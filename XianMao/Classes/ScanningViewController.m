...
@interface ScanningViewController ()<UIAlertViewDelegate,AVCaptureMetadataOutputObjectsDelegate,UINavigationControllerDelegate, UIImagePickerControllerDelegate>
...
{
    //1.下边栏
    UIView *bottomBar = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_maskView.frame)+kBorderW, self.view.sd_width, self.view.sd_height )];
...
-(void)captureOutput:(AVCaptureOutput *)captureOutput didOutputMetadataObjects:(NSArray *)metadataObjects fromConnection:(AVCaptureConnection *)connection{
    if (metadataObjects.count>0) {
        ...
        NSDictionary * dict = @{@"scannedResult":scannedResult};
        [[NSNotificationCenter defaultCenter] postNotificationName:@"scannedResult" object:nil userInfo:dict];
