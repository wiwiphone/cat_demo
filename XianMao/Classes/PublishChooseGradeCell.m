...
@interface PublishChooseGradeCell ()
...
@implementation PublishChooseGradeCell
...
+ (NSString *)reuseIdentifier {
    ...
    dispatch_once(&onceToken, ^{
        __reuseIdentifier = NSStringFromClass([PublishChooseGradeCell class]);
    });
...
{
    NSMutableDictionary *dict = [[super class] buildBaseCellDict:[PublishChooseGradeCell class]];
    if (data) {
