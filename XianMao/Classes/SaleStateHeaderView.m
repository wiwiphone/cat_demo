...
@implementation SaleStateHeaderView
...
-(CommandButton *)unPassVerify{
    if (!_unPassVerify) {
        ...
        [_unPassVerify setTitle:@"已售出" forState:UIControlStateNormal];
...
-(CommandButton *)passVerify{
    if (!_passVerify) {
        ...
        [_passVerify setTitle:@"寄卖中" forState:UIControlStateNormal];
...
-(CommandButton *)waitVerify{
    if (!_waitVerify) {
        ...
        [_waitVerify setTitle:@"待上架" forState:UIControlStateNormal];
