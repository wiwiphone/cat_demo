...
- (void)drawRect:(CGRect)rect {
    ...
    CGPathAddArc(trackPath, NULL, centerPoint.x, centerPoint.y, radius-0.1, DEGREES_2_RADIANS(270), DEGREES_2_RADIANS(-90), NO);
...
- (UIColor *)trackTintColor {
    if (!_trackTintColor) {
        _trackTintColor = [UIColor colorWithRed:0.0f green:0.0f blue:0.0f alpha:0.5f];
    }
