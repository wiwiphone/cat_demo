...
@implementation SwipeCellButton
...
+(instancetype) buttonWithTitle:(NSString *) title backgroundColor:(UIColor *) color padding:(NSInteger) padding callback:(SwipeButtonCallback) callback
{
...
+(instancetype) buttonWithTitle:(NSString *) title backgroundColor:(UIColor *) color insets:(UIEdgeInsets) insets callback:(SwipeButtonCallback) callback
{
...
+(instancetype) buttonWithTitle:(NSString *) title icon:(UIImage*) icon backgroundColor:(UIColor *) color insets:(UIEdgeInsets) insets callback:(SwipeButtonCallback) callback
{
    SwipeCellButton * button = [self buttonWithType:UIButtonTypeCustom];
...
-(BOOL) callMGSwipeConvenienceCallback: (SwipeTableViewCell *) sender
{
    if (_callback) {
