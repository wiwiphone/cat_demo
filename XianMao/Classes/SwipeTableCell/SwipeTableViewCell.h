...
typedef NS_ENUM(NSInteger, SwipeState) {
    SwipeStateNone = 0,
    SwipeStateSwipingLeftToRight,
    SwipeStateSwipingRightToLeft,
    SwipeStateExpandingLeftToRight,
    SwipeStateExpandingRightToLeft,
};

/** Swipe state */
typedef NS_ENUM(NSInteger, SwipeExpansionLayout) {
    SwipeExpansionLayoutBorder = 0,
    SwipeExpansionLayoutCenter,
    SwipeExpansionLayoutNone
};

/** Swipe Easing Function */
typedef NS_ENUM(NSInteger, SwipeEasingFunction) {
    SwipeEasingFunctionLinear = 0,
...
@property (nonatomic, assign) SwipeEasingFunction easingFunction;
...
@property (nonatomic, strong, nonnull) SwipeAnimation * showAnimation;
/** Animation settings when the swipe buttons are hided */
@property (nonatomic, strong, nonnull) SwipeAnimation * hideAnimation;
/** Animation settings when the cell is stretched from the swipe buttons */
@property (nonatomic, strong, nonnull) SwipeAnimation * stretchAnimation;
...
@property (nonatomic, assign) SwipeExpansionLayout expansionLayout;
/** Animation settings when the expansion is triggered **/
@property (nonatomic, strong, nonnull) SwipeAnimation * triggerAnimation;
 ...
 **/
-(BOOL) swipeTableCell:(nonnull SwipeTableViewCell*) cell canSwipe:(SwipeDirection) direction fromPoint:(CGPoint) point;
-(BOOL) swipeTableCell:(nonnull SwipeTableViewCell*) cell canSwipe:(SwipeDirection) direction DEPRECATED_ATTRIBUTE; //backwards compatibility
 ...
 **/
-(void) swipeTableCell:(nonnull SwipeTableViewCell*) cell didChangeSwipeState:(SwipeState) state gestureIsActive:(BOOL) gestureIsActive;

/**
 * Called when the user clicks a swipe button or when a expandable button is automatically triggered
 * @return YES to autohide the current swipe buttons
 **/
-(BOOL) swipeTableCell:(nonnull SwipeTableViewCell*) cell tappedButtonAtIndex:(NSInteger) index direction:(SwipeDirection)direction fromExpansion:(BOOL) fromExpansion;
/**
 ...
 **/
-(nullable NSArray<UIView*>*) swipeTableCell:(nonnull SwipeTableViewCell*) cell swipeButtonsForDirection:(SwipeDirection)direction
             swipeSettings:(nonnull SwipeSettings*) swipeSettings expansionSettings:(nonnull SwipeExpansionSettings*) expansionSettings;

/**
 * Called when the user taps on a swiped cell
 * @return YES to autohide the current swipe buttons
 **/
-(BOOL) swipeTableCell:(nonnull SwipeTableViewCell *)cell shouldHideSwipeOnTap:(CGPoint) point;

/**
 * Called when the cell will begin swiping
 * Useful to make cell changes that only are shown after the cell is swiped open
 **/
-(void) swipeTableCellWillBeginSwiping:(nonnull SwipeTableViewCell *) cell;

/**
 * Called when the cell will end swiping
 **/
-(void) swipeTableCellWillEndSwiping:(nonnull SwipeTableViewCell *) cell;
 ...
 */
@interface SwipeTableViewCell : BaseTableViewCell

/** optional delegate (not retained) */
@property (nonatomic, weak, nullable) id<SwipeTableCellDelegate> swipeCellDelegate;
...
@property (nonatomic, strong, nonnull) SwipeSettings * leftSwipeSettings;
@property (nonatomic, strong, nonnull) SwipeSettings * rightSwipeSettings;

/** Optional settings to allow expandable buttons */
@property (nonatomic, strong, nonnull) SwipeExpansionSettings * leftExpansion;
@property (nonatomic, strong, nonnull) SwipeExpansionSettings * rightExpansion;
...
-(void) showSwipe: (SwipeDirection) direction animated: (BOOL) animated completion:(nullable void(^)(BOOL finished)) completion;
-(void) setSwipeOffset:(CGFloat)offset animated: (BOOL) animated completion:(nullable void(^)(BOOL finished)) completion;
-(void) setSwipeOffset:(CGFloat)offset animation: (nullable SwipeAnimation *) animation completion:(nullable void(^)(BOOL finished)) completion;
