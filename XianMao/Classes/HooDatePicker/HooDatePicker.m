...
static CGFloat const kHooDatePickerScrollViewLeftMargin = 0.0f;

static CGFloat const kHooDatePickerScrollViewItemHeight = 45.0f;

static CGFloat const kHooDatePickerLineWidth = 0.5f;

static CGFloat const kHooDatePickerLineMargin = 0.0f;
...
#define kHooDatePickerHighlightColor [UIColor colorWithRed:0/255.0 green:120.0/255.0 blue:255.0/255.0 alpha:1.0]
...
#define kHooDatePickerLabelTextColor [UIColor colorWithRed:0/255.0 green:0/255.0 blue:0/255.0 alpha:1.0]
...
- (void)buildSelectorDaysOffsetX:(CGFloat)x andWidth:(CGFloat)width {
    ...
    _lineDaysTop.backgroundColor = kHooDatePickerLabelTextColor;
    ...
    _lineDaysBottom.backgroundColor = kHooDatePickerLabelTextColor;
...
- (void)buildSelectorMonthsOffsetX:(CGFloat)x andWidth:(CGFloat)width {
    ...
    _lineMonthsTop.backgroundColor = kHooDatePickerLabelTextColor;
    ...
    _lineMonthsBottom.backgroundColor = kHooDatePickerLabelTextColor;
...
- (void)buildSelectorYearsOffsetX:(CGFloat)x andWidth:(CGFloat)width {
    ...
    _lineYearsTop.backgroundColor = kHooDatePickerLabelTextColor;
    ...
    _lineYearsBottom.backgroundColor = kHooDatePickerLabelTextColor;
...
- (void)highlightLabelInArray:(NSMutableArray*)labels atIndex:(NSInteger)index {
    ...
    for (int i = 0; i < labels.count; i++) {
        ...
        if (i != index) {
            ...
            label.textColor = kHooDatePickerLabelTextColor;
