...
@implementation VerifyStateView
...
//        [_dDetermine setImage:[UIImage imageNamed:@"Mine_OnLine_MF"] forState:UIControlStateNormal];
        [_dDetermine setTitle:@"审核通过" forState:UIControlStateNormal];
...
//        [_dComeGoods setImage:[UIImage imageNamed:@"Mine_Help_MF"] forState:UIControlStateNormal];
        [_dComeGoods setTitle:@"审核未通过" forState:UIControlStateNormal];
...
-(void)getSendModel:(SendSaleModel *)sendModel{
    self.dSendGoodsLbl.text = [NSString stringWithFormat:@"(%ld)", sendModel.auditing];
    self.dDetermineLbl.text = [NSString stringWithFormat:@"(%ld)", sendModel.auditPass];
    self.dComeGoodsLbl.text = [NSString stringWithFormat:@"(%ld)", sendModel.noAudit];
}
