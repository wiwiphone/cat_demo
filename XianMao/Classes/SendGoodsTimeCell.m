...
@implementation SendGoodsTimeCell
...
+ (NSString *)reuseIdentifier {
    ...
    dispatch_once(&onceToken, ^{
        __reuseIdentifier = NSStringFromClass([SendGoodsTimeCell class]);
    });
...
{
    NSMutableDictionary *dict = [[super class] buildBaseCellDict:[SendGoodsTimeCell class]];
    if (data) {
