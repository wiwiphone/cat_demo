...
+ (NSString *)reuseIdentifier {
    ...
    dispatch_once(&onceToken, ^{
        __reuseIdentifier = NSStringFromClass([RecoveryCell class]);
    });
...
+ (NSMutableDictionary*)buildCellDict {
    NSMutableDictionary *dict = [[super class] buildBaseCellDict:[RecoveryCell class]];
