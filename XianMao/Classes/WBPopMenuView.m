...
- (instancetype) initWithFrame:(CGRect)frame
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        self.tableView.backgroundColor =[UIColor colorWithHexString:@"5b5b5b"];
...
- (CGRect)menuFrame {
    CGFloat menuX = kScreenWidth - self.menuWidth/2 - 5;
    CGFloat menuY = -15;
    CGFloat width = self.menuWidth;
    CGFloat heigh = 40 * self.menuItem.count;
...

{
    ...
    [[UIColor colorWithHexString:@"5b5b5b"] setFill];  //设置填充色
    
    [[UIColor colorWithHexString:@"5b5b5b"] setStroke]; //设置边框颜色
