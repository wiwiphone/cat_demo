...
@implementation MineGoodsShelfCell
...
+ (NSString *)reuseIdentifier {
    ...
    dispatch_once(&onceToken, ^{
        __reuseIdentifier = NSStringFromClass([MineGoodsShelfCell class]);
    });
...
{
    NSMutableDictionary *dict = [[super class] buildBaseCellDict:[MineGoodsShelfCell class]];
