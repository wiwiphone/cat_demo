...
- (void)setPlaceHolder:(NSString *)placeHolder {
    ...
    NSUInteger maxChars = [PlaceHolderTextView maxCharactersPerLine];
...
- (NSUInteger)numberOfLinesOfText {
    return [PlaceHolderTextView numberOfLinesForMessage:self.text];
}
...
+ (NSUInteger)numberOfLinesForMessage:(NSString *)text {
    return (text.length / [PlaceHolderTextView maxCharactersPerLine]) + 1;
}
