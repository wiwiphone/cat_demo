...
typedef void(^KeyboardWillChangeBlock)(CGRect beginKeyboardRect,CGRect endKeyboardRect, UIViewAnimationOptions options, double duration, BOOL showKeyborad);


@interface UIScrollView (KeyboardCtrl)
