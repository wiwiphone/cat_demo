...
- (void)initCenterLabel {
    CGFloat center =MIN(self.bounds.size.height/2, self.bounds.size.width/2+10);
    self.CGPoinCerter = CGPointMake(center, center);
    self.centerLable = [[UICountingLabel alloc] initWithFrame:CGRectMake(0, 0, 2*center, 2*center)];
...
//    CGFloat center =MIN(self.bounds.size.height/2, self.bounds.size.width/2-10);
//    self.CGPoinCerter = CGPointMake(center, center);
//    self.rmbLbl = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 2*center, 2*center)];
//    self.rmbLbl.textAlignment = NSTextAlignmentCenter;
//    self.rmbLbl.backgroundColor = [UIColor clearColor];
//    self.rmbLbl.adjustsFontSizeToFitWidth = YES;
//    self.rmbLbl.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
//    self.contentMode = UIViewContentModeRedraw;
...
-(void)initData{
    ...
    self.centerLable.font = [UIFont boldSystemFontOfSize:radius/2];
//    self.rmbLbl.font = [UIFont systemFontOfSize:radius/3];
}
